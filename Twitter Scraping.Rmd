...
write.xlsx(user_timelines, file="good_name_here.xlsx") #Just put in what you want the file to be called. Don't forget the .xlsx at the end! It won't work without it. It should just stick the new file into same folder as this R Studio document.
```
